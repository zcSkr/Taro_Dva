...
export default class GoodsInfo extends PureComponent {
  config = {
  ...
  handleAllCommentClick() {
    Taro.navigateTo({ url: `/pages/index/commentList?id=123` })
  }
      ...
      <View className={styles.page}>
        ...
        <View className={styles.commentWrap}>
          <View className={styles.titleWrap}>
            <View className={styles.title}>评价<Text className={styles.commentNum}>（52）</Text></View>
            <View onClick={this.handleAllCommentClick} className={styles.titleRight}>全部评价<AtIcon value='chevron-right' size='18' color='#CCCCCC'></AtIcon></View>
          </View>
          {
            [[], []].map((item, index) => (
